...
class ProductManager {
    private val products: List<AbstractMenu> = initProduct()

    private fun initProduct(): List<AbstractMenu> {
        val burger = listOf(
        ...
        val beverage = listOf(
            Beverage(0, "beverage", "Americano", 1000, "바로 내린 100% 친환경 커피로 더 신선하게! 더 풍부하게!", "Small"),
            Beverage(1, "beverage", "Americano", 1500, "바로 내린 100% 친환경 커피로 더 신선하게! 더 풍부하게!", "Medium"),
            Beverage(2, "beverage", "Café Latte", 1500, "바로 내린 100% 친환경 커피가 신선한 우유를 만나 더 신선하고 부드럽게!", "Small"),
            Beverage(3, "beverage", "Café Latte", 2000, "바로 내린 100% 친환경 커피가 신선한 우유를 만나 더 신선하고 부드럽게!", "Medium"),
